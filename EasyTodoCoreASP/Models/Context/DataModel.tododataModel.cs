...
// Code is generated on: 2017/09/09 16:13:44
//
...
namespace CoreContext
{
    ...
    public partial class tododataModel : DbContext
    {
        ...
        public tododataModel(DbContextOptions<tododataModel> options) :
            base(options)
        {
            OnCreated();
        }
        ...
        {
            optionsBuilder.UsePostgreSql(@"User Id=ruser;Password=raikou;Host=192.168.24.75;Database=tododata;Persist Security Info=True;Initial Schema=ruser");
